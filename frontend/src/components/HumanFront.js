...
const HumanFront = () => {
  ...
  const handleClick = (part, value) => {
    setBody({ [part]: value });
  };

  return (
    <section className="human-front">
      <div className="human-body">
        <svg
          onClick={() => handleClick("head", "head")}
          data-position="head"
          id="head"
          className="head"
        ...
        <svg
          onClick={() => handleClick("left-shoulder", "left-shoulder")}
        ...
        <svg
          onClick={() => handleClick("right-shoulder", "right-shoulder")}
        ...
        <svg
          onClick={() => handleClick("left-arm", "left-arm")}
        ...
        <svg
          onClick={() => handleClick("right-arm", "right-arm")}
        ...
        <svg
          onClick={() => handleClick("chest", "chest")}
          data-position="chest"
          id="chest"
          className="chest"
          xmlns="http://www.w3.org/2000/svg"
        ...
        <svg
          onClick={() => handleClick("stomach", "stomach")}
        ...
        <svg
          onClick={() => handleClick("left-leg", "left-leg")}
        ...
        <svg
          onClick={() => handleClick("right-leg", "right-leg")}
        ...
        <svg
          onClick={() => handleClick("left-hand", "left-hand")}
        ...
        <svg
          onClick={() => handleClick("right-hand", "right-hand")}
        ...
        <svg
          onClick={() => handleClick("left-foot", "left-foot")}
        ...
        <svg
          onClick={() => handleClick("right-foot", "right-foot")}
